...
<body>
	...
	<h1 style="text-align: center;height: 13px;margin-top: 105px;font-family: '微软雅黑",Arial,sans-serif';"></h1>
	<form action="loginServlet.do" class="form-horizontal" role="form" method="post">
		...
		<div class="form-group">
			...
			<div class="col-xs-offset-3 col-xs-6">
				<input id="userName" type="text" class="form-control" name="username" placeholder="UserName" autofocus="autofocus">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-1">
				<img alt="" src="randomcode.jpg" onclick="refreshImg(this)">
			</div>
		</div>
